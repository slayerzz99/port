...
export const metadata: Metadata = {
    ...
    colorScheme: "dark",
    openGraph: {
        title: "Tilak Adroja - Front end Developer",
        description:
      "Hobby Designer and Software Engineer, currently at india. Focused on immersive experiences.",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Tilak Adroja - Front end Developer",
            },
        ],
        locale: "en-US",
        type: "website",
